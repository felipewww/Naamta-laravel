            ...
            <div>
                <div class="white-box">
                    ...
                    <ul class="list-inline text-center">
                        ...
                        <li class="text-right"><a href="{{ asset('applications/'.$application->id.'/payment/deny') }}" class="btn btn-warning m-t-10">Deny</a></li>
                        <li class="text-right"><a href="{{ asset('applications/'.$application->id.'/payment/delete') }}" class="btn btn-danger m-t-10">Delete</a></li>
                    </ul>
                </div>
            </div>
        </div>
