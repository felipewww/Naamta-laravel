...
function addEvents(elem, id = null, signature = null){
  ...
  isIncorrect.change(function(){
    ...
    checkFieldValue(id, null, null, $(this).prop('checked'));
  });
...
function appendNavigation(){
  var html = '<div class="form-holder"><div class="tabs-options"><a class="btn btn-custom2 m-r-20" id="addTab">Add Page</a><a class="btn btn-save m-r-20" id="save">Save History</a><a class="btn btn-default" id="open-history">History</a></div><nav><ul></ul></nav><div class="tabs-holder"></div></div>';
  $('#drag-container').append(html);  
