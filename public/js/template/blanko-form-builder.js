...
function addEvents(elem, id = null, signature = null){
  ...
  $(elem).find('.drag-options .help-text').keyup(function(){
    $(elem).find('.help + .text').text($(this).val());
    if($(this).val() == ""){
  ...
  $(elem).find('.drag-input .update-value').change(function(){
    ...
    console.log($(elem).find('.drag-validate input[value="Fail"]'));
