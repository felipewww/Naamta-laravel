...
function addEvents(elem, id = null, signature = null){
  ...
  //Incorrect / Correct
  var isIncorrect = $(elem).find('input[name="incorrect"]');
  $(elem).find('.drag-heading').toggleClass('incorrect', $(isIncorrect).prop('checked'));
  isIncorrect.attr('name', isIncorrect.attr('name') + '__' + id)
  isIncorrect.change(function(){
    $(elem).find('.drag-heading').toggleClass('incorrect', $(this).prop('checked'));
  });
