...
function addEvents(elem, id = null){
  ...
  $(elem).find('.add-comment').click(function(){
    var fieldId = (id != null) ? id : (fieldCounter-1);
    var message = $(elem).find('.comment-msg');
    appendComment(username, message.val(), fieldId);
    message.val('');
  });
}
