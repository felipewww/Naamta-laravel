...
function addEvents(elem, id = null, signature = null){
  ...
  //rules
  var comparisonOptions = '<option value="==">Equals</option><option value="!=">Is not</option><option value="<">Less than</option><option value="<=">Less or equal</option><option value=">">More than</option><option value=">=">More or equal</option>';
...
function appendComment(user, msg, type, node){
  if(msg != ''){
