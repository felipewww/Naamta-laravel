...
// Appends fields menu
function appendList(){
  var html = $('<div id="list-container"> <h3>Input Types</h3> <ul class="input-list"> <li><a draggable="true" href="#header"><i class="fa m-r-10 fa-header"></i> Header</a></li><br><li><a draggable="true" href="#paragraph"><i class="fa m-r-10 fa-paragraph"></i> Paragraph</a></li><br><li><a draggable="true" href="#checkbox-group"><i class="fa m-r-10 fa-check-square"></i> Checkbox</a></li><br><li><a draggable="true" href="#radio-group"><i class="fa m-r-10 fa-check-circle"></i> Radio Button</a></li><br><li><a draggable="true" href="#select"><i class="fa m-r-10 fa-caret-down"></i> Select</a></li><br><li><a draggable="true" href="#date-field"><i class="fa m-r-10 fa-calendar"></i> Date Field</a></li><br><li><a draggable="true" href="#file-upload"><i class="fa m-r-10 fa-upload"></i> File Upload</a></li><br><li><a draggable="true" href="#number-field"><i class="fa m-r-10"><b>1</b></i> Number Field</a></li><br><li><a draggable="true" href="#text-field"><i class="fa m-r-10 fa-font"></i> Text Field</a></li><br><li><a draggable="true" href="#email-field"><i class="fa m-r-10 fa-envelope-o"></i> Email Field</a></li><br><li><a draggable="true" href="#phone-field"><i class="fa m-r-10 fa-puzzle-piece"></i> Masked Field</a></li><br><li><a draggable="true" href="#text-area"><i class="fa m-r-10 fa-align-justify"></i> Text Area</a></li><br><li><a draggable="true" href="#signature"><i class="fa m-r-10 fa-pencil"></i> Signature</a></li><br></ul></div>');
  if($('#drag-container.report-view').length > 0){
