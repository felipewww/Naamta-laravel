...
function addTab(){
  ...
  var modal = '<div class="modal modal-dialog modal-md"><div class="modal-content"><div class="modal-header"><button type="button" class="close" aria-hidden="true">×</button><h4 class="modal-title" id="mySmallModalLabel">Container Configuration</h4> </div><div class="modal-body"> ... </div></div></div>';
