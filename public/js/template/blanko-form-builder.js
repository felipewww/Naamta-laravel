...
function appendModel(){
  var html = $('<div id="input-types" class="hidden"> <div class="draggable-input panel" data-id="" id="checkbox-group"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Checkbox</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Checkbox </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group checkbox-group update-required"> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Checkbox"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="options"> <div class="form-group"> <label class="control-label col-sm-2">Options</label> <div class="col-sm-4"> <input placeholder="" type="text" class="form-control label-input" placeholder="Label"> </div><a href="#" class="add-options btn btn-success">Add </a> </div><div class="form-group"> <div class="col-sm-10 col-sm-offset-2"> <table class="table color-table muted-table"> <thead> <tr> <th>Label</th> <th>Value</th> <th></th> </tr></thead> <tbody class="options-table"></tbody> </table> </div></div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="radio-group"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Radio Button</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Radio Button </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group radio-group update-required"> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Radio Button"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="options"> <div class="form-group"> <label class="control-label col-sm-2">Options</label> <div class="col-sm-4"> <input placeholder="" type="text" class="form-control label-input" placeholder="Label"> </div><a href="#" class="add-options btn btn-success">Add </a> </div><div class="form-group"> <div class="col-sm-10 col-sm-offset-2"> <table class="table color-table muted-table"> <thead> <tr> <th>Label</th> <th>Value</th> <th></th> </tr></thead> <tbody class="options-table"> </tbody> </table> </div></div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="select"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Select</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Select </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <select class="form-control update-required update-value"><option value="initial-value">Select one</option></select> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Select"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="options"> <div class="form-group"> <label class="control-label col-sm-2">Options</label> <div class="col-sm-4"> <input placeholder="" type="text" class="form-control label-input" placeholder="Label"> </div><a href="#" class="add-options btn btn-success">Add </a> </div><div class="form-group"> <div class="col-sm-10 col-sm-offset-2"> <table class="table color-table muted-table"> <thead> <tr> <th>Label</th> <th>Value</th> <th></th> </tr></thead> <tbody class="options-table"><tr class="hidden"><td>Label</td><td>Value</td><td class="text-nowrap"></td></tr></tbody> </table> </div></div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="date-field"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Date Field</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Date Field </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <input placeholder="" type="date" class="form-control update-value update-required"> </div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Date Field"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="form-group"> <label class="control-label col-sm-2">Initial Value</label> <div class="col-sm-10"> <input placeholder="" type="date" class="form-control value"> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="file-upload"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>File Upload</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">File Upload </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"></div></div><h5 class="bold">Files <i class="fa fa-arrow-down"></i></h5> <div class="file-holder"></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="File Upload"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="header"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Static Header</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-input"> <h3 class="update-label">Header</h3> </div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Header"> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div></div></div><div class="draggable-input panel" data-id="" id="paragraph"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Static Paragraph</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-input"> <div class="update-paragraph">Paragraph</div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <label class="control-label col-sm-2">Content</label> <div class="col-sm-10"> <div contenteditable="true" class="form-control paragraph-content">Paragraph</div></div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div></div></div><div class="draggable-input panel" data-id="" id="number-field"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Number Field</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Number Field </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <input placeholder="" type="number" class="form-control update-value update-required update-min update-max update-step" min="" max="" step=""> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Number Field"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="form-group"> <label class="control-label col-sm-2">Min</label> <div class="col-sm-10"> <input placeholder="" type="number" class="form-control min-value"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Max</label> <div class="col-sm-10"> <input placeholder="" type="number" class="form-control max-value"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Step</label> <div class="col-sm-10"> <input placeholder="" type="number" class="form-control step-value"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Initial Value</label> <div class="col-sm-10"> <input placeholder="" type="number" class="form-control value"> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="text-field"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Text Field</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Text Field </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <input placeholder="" type="text" maxlength="62" class="form-control update-value update-required"> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Text Field"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="form-group"> <label class="control-label col-sm-2">Initial Value</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control value"> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="email-field"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>E-mail Field</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">E-mail Field </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <input placeholder="" type="email" class="form-control update-value update-required"> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="E-mail Field"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="form-group"> <label class="control-label col-sm-2">Initial Value</label> <div class="col-sm-10"> <input placeholder="" type="email" class="form-control value"> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="phone-field"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Masked Field</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Masked Field </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <input placeholder="" type="text" class="form-control update-value update-required"> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Masked Field"> </div></div><div class="form-group"> <label class="control-label col-sm-2" title="Ex: (000) 000-0000">Mask</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control mask" value="(000) 000-0000"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="form-group"> <label class="control-label col-sm-2">Initial Value</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control value"> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="text-area"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Text Area</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body" draggable="false"> <div class="drag-label"> <label class="update-label">Text Area </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <textarea class="form-control update-value update-required"></textarea> </div></div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Text Area"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div><div class="form-group"> <label class="control-label col-sm-2">Initial Value</label> <div class="col-sm-10"> <textarea class="form-control value"></textarea> </div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div><div class="draggable-input panel" data-id="" id="signature"> <div class="drag-heading" draggable="true"> <span class="ordenation"></span> <h4>Signature</h4> <ul> <li><i class="fa expand-field"></i></li><li><i class="fa fa-clone"></i></li><li><i class="fa fa-cog"></i></li><li><i class="fa fa-times"></i></li></ul> </div><div class="panel-body " draggable="false"> <div class="drag-label"> <label class="update-label">Signature </label><span class="span-required">*</span> <div class="help"> <div class="icon"><i class="fa fa-question-circle"></i></div><div class="comment-icon"></div></div><div class="text"></div></div><div class="drag-input"> <div class="form-group"> <button class="clear btn btn-default">Clear</button> </div><canvas class="update-required"></canvas> </div><div class="hidden drag-options form-horizontal p-t-20"> <h4>Options</h4> <div class="form-horizontal"> <div class="form-group"> <div class="col-sm-offset-2 col-sm-10 required-field"> <div class="checkbox checkbox-success"> <input placeholder="" type="checkbox" class="is-required"> <label> Required </label> </div></div></div><div class="form-group"> <label class="control-label col-sm-2">Label</label> <div class="col-sm-10"> <input placeholder="" type="text" class="form-control label-text" value="Signature"> </div></div><div class="form-group"> <label class="control-label col-sm-2">Help Text</label> <div class="col-sm-10"> <div class="help-formatter"> </div><p class="help-text" contenteditable="true" rows="15"> </p></div></div></div></div><div class="hidden drag-comments p-t-20"> <h4 class="active open-external">Comments</h4> <h4 class="open-internal">Internal Comments</h4> <ul class="comments external-comments"></ul> <ul class="comments internal-comments"></ul> <div class="comment-input row"> <div class="form-group"> <div class="col-sm-12"> <textarea comment-type="external" placeholder="Type your comment here" class="comment-msg form-control"></textarea> </div><div class="col-sm-3 radio text-right pull-right"> <a class="btn btn-default add-comment">Send</a> </div></div></div></div><div class="drag-validate"> <div class="radio"> <input placeholder="" type="radio" name="incorrect" class="is-incorrect" value="Pass"> <label> Pass </label> </div><div class="radio"> <input type="radio" name="incorrect" class="is-incorrect" value="Fail"> <label> Fail </label> </div><div class="radio"> <input type="radio" name="incorrect" class="is-incorrect" value="Audit"> <label> Site Audit </label> </div></div></div></div></div>');
